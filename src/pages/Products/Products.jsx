    ...
    <div className='products'>
      <div className="left">
        ...
        <div className="filterItem">
          ...
          <div className="inputItem inputItem-cus">
            <span>0</span>
        ...
        <div className="filterItem">
          ...
          <div className="inputItem">
            <input type="radio" id="dsc" value="dsc" name="price" onChange={e => setSort(e.target.value)} />
            <label htmlFor="dsc">Price (Higher first)</label>
          </div>
        </div>
      </div>
      <div className="right">
